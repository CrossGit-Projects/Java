                        ...
                        <div class="box-body">
                            <div class="col-sm-6">
                                <div  align="center">
                                    ...
                                    <div class="span2">
                                        <img src="data:image/jpeg;base64,${image}" width="88" height="88" alt="..." class="img-rounded">
                                    </div>
                            ...
                            <div class="col-sm-5 col-xs-6 tital " ><s:message code="card.firstName"/></div><div class="col-sm-7"><c:out value="${user.telephone}"/></div>
                            ...
                            <div class="col-sm-5 col-xs-6 tital " ><s:message code="card.postCode"/></div><div class="col-sm-7"><c:out value="${card.postCode}"/></div>

                            <div class="clearfix"></div>
                            <div class="bot-border"></div>

                            <div class="col-sm-5 col-xs-6 tital " ><s:message code="card.dateOfBirth"/></div><div class="col-sm-7"><c:out value="${card.dateOfBirth}"/></div>
                            ...
                            <div class="col-sm-5 col-xs-6 tital " ><s:message code="card.gender"/></div><div class="col-sm-7"><c:out value="${card.gender}"/></div>
...
<a href="/patient/inputCardPatient">
