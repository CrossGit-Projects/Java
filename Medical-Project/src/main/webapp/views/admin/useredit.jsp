...
<sf:form id="usersForm" action="${pageContext.request.contextPath}/admin/updateuser/${user.id}" modelAttribute="user" method="POST">
		...
		<table width="500" border="0" cellpadding="4" cellspacing="1"
			...
			<tr>
				...
				<td width="270" align="left"><sf:select path="enabled" items="${activityMap}"/></td>
			</tr>
