...
public class MyAppUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(final String email) throws UsernameNotFoundException {
        ...
        com.dmcs.karol.domain.AppUser appUser = appUserService.findByEmail(email);
    ...
    private User buildUserForAuthentication(com.dmcs.karol.domain.AppUser appUser, List<GrantedAuthority> authorities) {
