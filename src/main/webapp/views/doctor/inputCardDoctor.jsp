...
<div class="container contact">
    <div class="row">
        <div class="col-md-3">
            ...
            <form:form method="post" action="saveCardDoctor" modelAttribute="cardDoctor" >

            <div class="contact-info">
                <img src="https://image.ibb.co/kUASdV/contact-image.png" alt="image"/>
                <h2>Card Doctor</h2>
                <h4>Edit your card doctor and begin with us !</h4>
            </div>
        </div>
        <div class="col-md-9">
            <div class="contact-form">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" ><s:message code="card.specialization"/></label>
                    <div class="col-sm-10">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control"  placeholder="Enter street:" name="street">
                    </div>
                </div>
                <div class="form-group">
