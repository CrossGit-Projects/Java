                ...
                <tr onmouseover="changeTrBg(this)" onmouseout="defaultTrBg(this)">
                    ...
                    <c:choose>
                        ...
                        <c:when test ="${u.nrRoli == 3 }">
                                <font color ="red"><s:message code="word.doctor"/></font>
                        </c:when>
                        <c:otherwise>
                                <s:message code="word.patient"/>
                        </c:otherwise>
                     </c:choose>
                     </td>
                    <td>
                        <c:choose>
                            <c:when test="${u.nrRoli == 1 }">
                                <img src="${pageContext.request.contextPath}/resources/images/deliconinact.png" width="20" height="20" alt="karol">
                            </c:when>
                            <c:otherwise>
                                <a href="delete/${u.id }">
                                    <img src="${pageContext.request.contextPath}/resources/images/delicon.png" width="20" height="20" title="<s:message code="delete.user"/>" alt="karol">
                                </a>
                            </c:otherwise>
                        </c:choose>
                    </td>
